    ...
    if (action === 'cargarFormulario') {
      ...
      const preguntas = id === 'LIMPIEZA_MOTO'
        ...
        : [
            ...
            { id_pregunta: 'DOC_LICENCIA_VENCE', orden: 0, seccion: 'Documentación del vehículo', pregunta: 'Fecha de vencimiento de la Licencia de Tránsito', tipo_respuesta: 'fecha', obligatorio: 'SI', depende_de: 'DOC_PRIMERA_O_RENOVACION', depende_valor: 'SI', documento: 'LICENCIA', ayuda: 'Escríbela como aparece en el documento.' },
            ...
            { id_pregunta: 'DOC_SOAT_VENCE', orden: 0, seccion: 'Documentación del vehículo', pregunta: 'Fecha de vencimiento del SOAT', tipo_respuesta: 'fecha', obligatorio: 'SI', depende_de: 'DOC_PRIMERA_O_RENOVACION', depende_valor: 'SI', documento: 'SOAT', ayuda: 'Escríbela como aparece en el documento.' },
            ...
            { id_pregunta: 'DOC_TECNOMECANICA_VENCE', orden: 0, seccion: 'Documentación del vehículo', pregunta: 'Fecha de vencimiento de la Revisión Tecnomecánica', tipo_respuesta: 'fecha', obligatorio: 'SI', depende_de: 'DOC_PRIMERA_O_RENOVACION', depende_valor: 'SI', documento: 'TECNOMECANICA', ayuda: 'Escríbela como aparece en el documento.' },
