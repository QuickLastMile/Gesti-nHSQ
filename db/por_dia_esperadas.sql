-- ============================================================
--  Gestión HSEQ Motos — Serie diaria de cumplimiento
--  ------------------------------------------------------------
--  El dashboard rediseado muestra una tendencia de CUMPLIMIENTO,
--  no de cantidad de registros. Para eso necesita saber cuántos
--  registros se esperaban cada día, no solo cuántos llegaron.
--
--  Se agrega la clave 'por_dia_cumplimiento'. Es aditivo: 'por_dia'
--  queda igual y ningún cálculo existente cambia. Mientras no se
--  ejecute este script, la tendencia muestra registros por día y
--  lo dice en pantalla.
--
